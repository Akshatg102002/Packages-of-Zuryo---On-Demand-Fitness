...
export const Home: React.FC = () => {
    ...
    return (
        <div className="pb-4 md:pt-4 space-y-0 bg-gray-50 relative">
            ...
            {/* Mobile Header */}
            <header className="px-6 pt-4 pb-4 flex justify-between items-center md:hidden mb-6">
                ...
                <div className="px-0 md:px-8 mb-12 md:mb-16">
                    <div className="relative md:rounded-[40px] overflow-hidden min-h-[600px] md:h-[700px] flex items-center justify-center p-6 md:p-16 shadow-none md:shadow-2xl md:shadow-secondary/20 group">
                        ...
                        <div className="relative z-10 w-full max-w-4xl flex flex-col items-center text-center">
                            ...
                            {/* Subheadline/Tagline */}
                            <p className="text-gray-200 text-lg md:text-xl font-medium mb-10 max-w-2xl leading-relaxed text-shadow-lg">
                                Premium certified trainers at your apartment Gym in{" "}
                                <span className="text-white font-bold underline decoration-primary decoration-4 underline-offset-4">
                                    60 minutes
                                </span>.
                                <span className="block mt-2">
                                    No memberships. No commute. Just results.
                                </span>
                            </p>
                ...
                <div className="px-6 md:px-8 py-4 mb-16 md:mb-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <ValueCard
                            ...
                            desc="Certified trainers at your doorstep within 60 mins of booking."
