                ...
                <div className="flex items-center justify-between relative z-10">
                    {(bookingType === 'PACKAGE' ? [1, 3, 4] : [1, 2, 3, 4]).map((i, idx) => (
                        <div key={i} className={`flex flex-col items-center gap-2 transition-all duration-300 ${step >= i ? 'scale-110' : 'opacity-80'}`}>
                            <div className={`w-12 h-12 rounded-full flex items-center justify-center font-black text-base transition-all duration-300 shadow-md ${step >= i ? 'bg-primary text-secondary' : 'bg-white text-gray-400 border-2 border-gray-200'
                                }`}>
                                {idx + 1}
                            </div>
                ...
                <div className="flex-1 min-h-[400px]">
                    {step === 1 && (
                        <div className="animate-in slide-in-from-right duration-300">
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-8">
                                    {CATEGORIES.map(cat => (
                                        <button
                                            ...
                                            className={`relative p-5 rounded-3xl border-2 transition-all flex flex-col items-start gap-3 h-32 md:h-40 justify-between ${cat.active
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        {PACKAGES.map(pkg => (
                                            <button
                                                ...
                                                className={`relative p-6 rounded-3xl border-2 transition-all flex flex-col text-left gap-4 ${selectedPackageId === pkg.id
                            ...
                            <div className="bg-gradient-to-br from-[#0f1f3a] to-[#162b52] p-5 rounded-2xl border border-[#243b6b] mt-2">
                                <div className="flex items-center justify-between mb-3">
                                    <h3 className="text-xs font-black text-gray-300 uppercase tracking-widest flex items-center gap-1">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-[#0b1830] text-gray-100 placeholder-gray-500 min-h-[60px] resize-none rounded-xl px-4 py-3 border border-[#243b6b] focus:outline-none focus:ring-2 focus:ring-orange-500"
                                />

                                <div className="mt-6 bg-gradient-to-r from-[#1a2947] to-[#243554] p-5 rounded-2xl border-l-4 border-orange-500 shadow-xl">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium text-gray-300 mb-1">
                                                We are currently serving in
                                            </p>
                                            <p className="text-lg md:text-xl font-black bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent">
                                                SARJAPUR • BELLANDUR • HSR LAYOUT
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {next3Days.map((date) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`min-w-[100px] py-4 rounded-2xl border-2 flex flex-col items-center justify-center transition-all ${isSelected ? 'border-primary bg-secondary text-white' : 'border-gray-100 bg-white text-gray-400'
                                                }`}
                                        >
