              ...
              <div className="space-y-4">
                <div>
                    ...
                    <input 
                        ...
                        className="w-full p-4 bg-gray-50 rounded-xl border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none font-semibold text-gray-900"
                ...
                <div>
                    ...
                    <div className="relative">
                        <input 
                            ...
                            className="w-full p-4 pl-12 bg-gray-50 rounded-xl border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary outline-none font-semibold text-gray-900"
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full p-4 bg-gray-50 rounded-xl border border-gray-200 outline-none font-semibold text-gray-900"
                            placeholder="Years"
                        />
                    </div>
                    <div>
          ...
          {step === 4 && (
             <div className="space-y-6 animate-in slide-in-from-right-10 duration-300">
                ...
                <textarea 
                    ...
                    className="w-full h-32 p-4 bg-gray-50 rounded-xl border border-gray-200 outline-none font-medium resize-none text-gray-900"
