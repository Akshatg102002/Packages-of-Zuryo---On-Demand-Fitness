...
export const Footer: React.FC = () => {
    ...
    return (
        <>
                    ...
                    <div className="grid grid-cols-4 gap-12 mb-16">
                        ...
                        <div className="col-span-1 space-y-6">
                            <div className="flex items-center gap-3">
                                <div className="w-16 h-16 bg-white border border-white/10 rounded-xl flex items-center justify-center shadow-sm overflow-hidden backdrop-blur-sm">
                            ...
                            <div className="flex gap-4">
                                <a
                                    href="https://www.facebook.com/share/1BL38YML6X/"
                                    target="_blank"
                                ...
                                <a
                                    href="https://www.instagram.com/_zuryo_/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
            ...
            {/* Mobile Footer */}
            <footer className="md:hidden bg-[#0b1736] text-white pt-10 pb-28 px-6 rounded-t-[32px] mt-8">
